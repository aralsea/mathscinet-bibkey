...
def main(bibtex_file_path: click.Path) -> None:
    ...
    It processes the input .bib file and generates a new file with the prefix 'converted_', containing the transformed keys while preserving all other bibliographic information.
    """
